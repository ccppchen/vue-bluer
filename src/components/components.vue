...
<div class="demo">
  ...
  <bl-popup v-model="popupVisible1" position="bottom" class="mint-popup-4" style="width: 100%;">
    <h1>popup</h1>
    <p>/ ˈpɑpˌʌp /</p>
    <p>n. 弹出式; [棒]内野飞球; 自动起跳式装置</p>
    <p>adj. 弹起的; 有自动起跳装置的</p>
  </bl-popup>
  <bl-popup v-model="popupVisible2" position="bottom" class="mint-popup-4" style="width: 100%;">
  ...
  <bl-scroll :enableRefresh="true" :onRefresh="onRefresh" :on-infinite="onInfinite" :enableInfinite="isLoading">
    <div class="components" style="padding: 10px 20px;">
      ...
      <div class="toast-box">
        <h3>toast</h3>
        <bl-button type="other" size="middle" @click="toast">toast{{ timeCoundDown }}</bl-button>
      ...
      <div class="bl-actionsheet-box">
        ...
        <bl-button type="other" size="middle" @click="sheetVisible = !sheetVisible">带取消按钮的actionsheet</bl-button>{{sheetVisible}}
        <bl-button type="other" size="middle" @click="sheetVisible2 = !sheetVisible2">不带取消按钮的actionsheet</bl-button>{{sheetVisible}}
      </div>
      ...
      <div class="bl-picker-box">
        <h3>bl-picker</h3>
        <bl-button type="other" size="middle" @click="popupVisible2 = !popupVisible2">bl-picker</bl-button>
      </div>
